...
Report bugs at https://github.com/6396262-bdeb-qc-ca/donnees.montreal.ca/issues.
...
Montreal_Donnees could always use more documentation, whether as part of the official docs, in docstrings, or even on the web in blog posts, articles, and such.
...
The best way to send feedback is to file an issue at https://github.com/6396262-bdeb-qc-ca/donnees.montreal.ca/issues.
...
Ready to contribute? Here's how to set up donnees.montreal.ca for local development.

1. Fork the donnees.montreal.ca repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/donnees.montreal.ca.git
   ```
